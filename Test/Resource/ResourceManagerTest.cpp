...
TEST_F(ResourceManagerTest, LoadShaderAsset)
{
    ...
    EXPECT_NE(loadedShader->GetID(), UUID());
...
TEST_F(ResourceManagerTest, UpdateTextureAsset)
{
    ...
    mResourceManager.UpdateAsset(texture->GetID(), texture);
